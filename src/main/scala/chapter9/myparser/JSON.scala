...
object JSON {
  ...
  def jsonParser[Parser[+_]](P: Parsers[Parser]): Parser[JSON] = {
    //hide the string implicit conversion and promote strings to tokens.
    //Then you don't have to write token everywhere.
    import P.{string => _,_}
...
object MYJSONExample extends App {
    val jsonTxt = """
{
...
"""
  ...
  val malformedJson1 = """{"Company name" ; "Microsoft Corporation"}"""
